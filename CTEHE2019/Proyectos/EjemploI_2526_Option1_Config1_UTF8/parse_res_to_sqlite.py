...
def parse_and_insert(res_file_path, db_file_path, project_name):
    ...
    # --- FIX: Open the file with latin-1 encoding ---
    try:
        with open(res_file_path, 'r', encoding='latin-1') as f:
            lines = f.readlines()
...
def main():
    # Corrected path to the .res file you mentioned
    ...
    # Derive project name from the folder structure
