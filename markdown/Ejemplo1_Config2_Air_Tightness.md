Of course. Here is a comprehensive extraction of all information related to air tightness (`estanqueidad` or `permeabilidad al aire`) from the document.
...
### 1. Air Permeability of Openings (`Permeabilidad al aire de los huecos`)
...
### 2. Building Envelope Air Tightness (`Relación del cambio de aire n₅₀`)
...
#### 2.2. Calculation of Permeability (`n₅₀`)
...
#### 2.3. Application and Compliance in the Document
...
*   **Compliance Strategy for Option 3 (Page 59):**
