...
**Where:**
*   **Loss Coefficient** ($A \cdot U$): Provided in the system specs.
    *   Options 1 & 2 (100L tank): 0.5 W/°C
    *   Option 3 (150L tank): 0.8 W/°C
*   $\Delta T$: Temperature difference between tank interior (65°C) and ambient (20°C) = **45°C**

**Calculation for Option 2:**
*   **For January (744 hours):**
