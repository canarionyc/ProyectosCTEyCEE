...
![Heating_Demand](Heating_Demand.png)
...
│   ~75 percent - System Efficiency   │
└─────────────────────────────────────┘
```


\begin{center}
\includegraphics[width=0.8\textwidth]{floor_heating.pdf}
\end{center}
...
![Factores de Paso](Factores_de_Paso.png)
