...
`Monthly Losses (Wh) = Loss Coefficient (W/°C) × ΔT (°C) × Hours in Month`

**Where:**
*   **Loss Coefficient (A·U):** Provided in the system specs.
    *   Options 1 & 2 (100L tank): `0.5 W/°C`
    *   Option 3 (150L tank): `0.8 W/°C`
*   **ΔT:** Temperature difference between tank interior (65°C) and ambient (20°C) = **45°C**
...
**Formula (Page 49):**
`Equivalent Volume (l/day) = Daily Energy Loss (Wh/day) / [ΔT × C_a × ρ_a]`

**Where:**
*   **ΔT:** Temperature rise (60°C - T_cold). `T_cold` is the annual average cold water temperature at the project altitude.
*   **C_a:** Specific heat capacity of water = **1.163 Wh/(kg·K)**
*   **ρ_a:** Density of water ≈ **1 kg/l**

**Calculation for Option 2 (Page 49):**
*   Daily Energy Loss = `540 Wh/day`
*   ΔT = `60°C - 9.74°C = 50.26°C` (9.74°C is the average cold water temp for the location)
